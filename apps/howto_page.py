        ...
        dbc.Card([
            dbc.CardBody([
                ...
                dbc.Row([
                    ...
                    dbc.Col(dbc.CardLink(dbc.CardImg(src="assets/API_permissions.png", style={'width': 400}, className="bordered-img"), href="assets/API_permissions.png"), className="centered-col"),
                ],
#                        justify = "end",
                align="center",
                ),
