        ...
        dbc.Card([
            dbc.CardBody([
                ...
                dbc.Row([
                    ...
                    dbc.Col(dbc.CardLink(dbc.CardImg(src="assets/API_permissions.png", style={'width': 400, 'margin': 10}), href="assets/API_permissions.png"), className="centered-col"),
                ],
#                        justify = "end",
                align="center",
                ),
            ...
            dbc.Row([
                ...
                dbc.Col(dbc.CardLink(dbc.CardImg(src="assets/home.png", style={'width': 400, 'margin': 10}), href="assets/home.png"), className="centered-col"),
            ],
            align="center",),
            ...
            dbc.Row([
                ...
                dbc.Col(dbc.CardLink(dbc.CardImg(src="assets/summary_table.png", style={'width': '95%', 'margin': 10}), href="assets/summary_table.png"), className="centered-col"),
            ],
                    align="center"),
            ...
            dbc.Row([
                ...
                dbc.Col(dbc.CardLink(dbc.CardImg(src="assets/award_bar_chart.png", style={'width': '60%', 'margin': 10}), href="assets/award_bar_chart.png"), className="centered-col")
            ],
            align="center"),
            ...
            dbc.Row([
                ...
                dbc.Col(dbc.CardLink(dbc.CardImg(src="assets/distance_bar_chart.png", style={'width': '60%', 'margin': 10}), href="assets/distance_bar_chart.png"), className="centered-col")
            ],
                    align="center"),

            dbc.Row([
                dbc.Col("Next up are Details. "),
                dbc.Col(dbc.CardLink(dbc.CardImg(src="assets/details.png", style={'width': 400, 'margin': 10}), href="assets/details.png"), className="centered-col")
            ],
                    align="center"),
            ...
            dbc.Row([
                ...
                dbc.Col(dbc.CardLink(dbc.CardImg(src="assets/sorting_order.png", style={'width': "70%", 'margin': 10}), href="assets/sorting_order.png"), className="centered-col")
            ],
                    align="center"),
            ...
            dbc.Row([
                dbc.Col(dbc.CardLink(dbc.CardImg(src="assets/profile_from_api.png", style={'width': 600, 'margin': 10}), href="assets/profile_from_api.png"), className="centered-col"),
                dbc.Col(dbc.CardLink(dbc.CardImg(src="assets/profile_from_graph.png", style={'width': 600, 'margin': 10}), href="assets/profile_from_graph.png"), className="centered-col"),
                dbc.Col(dbc.CardLink(dbc.CardImg(src="assets/profile_from_prof.png", style={'width': 200, 'margin': 10}), href="assets/profile_from_prof.png"), className="centered-col"),
            ]),
            ...
            dbc.Row([
                ...
                dbc.Col(dbc.CardLink(dbc.CardImg(src="assets/profile_overview.png", style={'margin': 10}), href="assets/profile_overview.png"), className="centered-col"),
            ],
                    align="center"),
            ...
            dbc.Row([
                ...
                dbc.Col(dbc.CardLink(dbc.CardImg(src="assets/line_chart_annotated.png", style={'width': "80%", 'margin': 10}), href="assets/line_chart_annotated.png"), className="centered-col"),
            ],
                    align="center"),
            ...
            dbc.Row([
                ...
                dbc.Col(dbc.CardLink(dbc.CardImg(src="assets/hover_bar_chart.png", style={'width': "80%", 'margin': 10}), href="assets/hover_bar_chart.png"), className="centered-col"),
            ],
                    align="center"),
            ...
            dbc.Row([
                ...
                dbc.Col(dbc.CardLink(dbc.CardImg(src="assets/profile_table.png", style={'width': "80%", 'margin': 10}), href="assets/profile_table.png"), className="centered-col"),
            ],
                    align="center"),
